...
public class LlamaLibrary implements Library {
	...
	@Deprecated
	public static native NativeSize llama_copy_state_data(LlamaLibrary.llama_context ctx, Pointer dst);
	public static native NativeSize llama_copy_state_data(LlamaLibrary.llama_context ctx, ByteBuffer dst);
	@Deprecated
	public static native NativeSize llama_set_state_data(LlamaLibrary.llama_context ctx, Pointer src);
	...
	public static native int llama_get_vocab(LlamaLibrary.llama_context ctx, PointerByReference strings, FloatByReference scores, int capacity);
	public static native int llama_get_vocab_from_model(LlamaLibrary.llama_model model, PointerByReference strings, FloatByReference scores, int capacity);
	...
	public static native void llama_sample_repetition_penalty(LlamaLibrary.llama_context ctx, llama_token_data_array candidates, IntByReference last_tokens, NativeSize last_tokens_size, float penalty);
	public static native void llama_sample_frequency_and_presence_penalties(LlamaLibrary.llama_context ctx, llama_token_data_array candidates, IntByReference last_tokens, NativeSize last_tokens_size, float alpha_frequency, float alpha_presence);
	...
	public static native int llama_sample_token_mirostat(LlamaLibrary.llama_context ctx, llama_token_data_array candidates, float tau, float eta, int m, FloatByReference mu);
	public static native int llama_sample_token_mirostat_v2(LlamaLibrary.llama_context ctx, llama_token_data_array candidates, float tau, float eta, FloatByReference mu);
