...
public class LlamaLibrary implements Library {
	...
	public static native int llama_get_vocab(LlamaLibrary.llama_context ctx, String[] strings, FloatBuffer scores, int capacity);
	public static native int llama_get_vocab_from_model(LlamaLibrary.llama_model model, String[] strings, FloatBuffer scores, int capacity);
	...
	public static native LlamaLibrary.llama_grammar llama_grammar_init(llama_grammar_element.ByReference[] rules, NativeSize n_rules, NativeSize start_rule_index);
